...
-- Corriger toutes les fonctions qui référencent oneci_status
...
-- 3. Fonction get_verification_details (utilise cnib_data au lieu de oneci_data)
...
-- Mettre à jour les colonnes du profil pour utiliser cnib au lieu de oneci
DO $$ 
BEGIN
