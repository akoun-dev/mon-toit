...
-- Description: Drop the view and recreate user_roles_summary as a proper table

-- Drop the existing view first
DROP VIEW IF EXISTS public.user_roles_summary;

-- Create user_roles_summary as a table
...
DROP TRIGGER IF EXISTS trigger_update_user_roles_summary_insert ON public.profiles;
DROP TRIGGER IF EXISTS trigger_update_user_roles_summary_update ON public.profiles;
DROP TRIGGER IF EXISTS trigger_update_user_roles_summary_delete ON public.profiles;
...
DELETE FROM public.user_roles_summary; -- Clear existing data
...
GRANT EXECUTE ON FUNCTION update_user_roles_summary() TO authenticated;