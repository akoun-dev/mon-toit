...
-- ALTER FUNCTION public.generate_receipt_number() SET search_path = public; -- Function does not exist
ALTER FUNCTION public.notify_certification_status_change() SET search_path = public;
-- ALTER FUNCTION public.set_receipt_number() SET search_path = public; -- Function does not exist
